...
QUESTIONS = [
    ...
    "Опишите ситуацию, в которой вы чувствуете «застой» или «пробуксовку». Что именно не движется, несмотря на ваши усилия?",
    
    # Шаг 2: Фоновый шум (DMN)
    "Когда вы ничем не заняты, какие мысли возникают сами по себе? Опишите ваш «фоновый шум» — что мозг пережевывает в режиме по умолчанию?",
    
    # Шаг 3: Телесная доминанта (исправленная логика)
    "Представьте, что застой из Шага 1 — это физический объект в вашем теле. Где он находится и каков он (форма, вес, температура, материал)?",
    
    # Шаг 4: Механизм самоограничения
    "Как вы сами поддерживаете этот застой? Какие мысли или действия создают «тормоз» в этой ситуации?",
...
2. **Доминанта:**
   ...
   - Объясни, что «стена/камень» — это сила собственного торможения
...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        welcome_text = (
            ...
            "Я помогу Вам обнаружить скрытые программы «Автопилота», которые блокируют Вашу энергию.\n"
            "Мы пройдем 7 шагов по методу МПТ, чтобы найти Вашу личную **Метаформулу**.\n\n"
            "Готовы?"
        )
