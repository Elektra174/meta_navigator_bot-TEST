...
Q3 (Метафора): Объективизируй Доминанты. Используй образ пользователя как якорь для объяснения потери энергии.
        ...
        if next_step < len(QUESTIONS):
            ...
            try:
                ...
                if report:
                    ...
                    await message.answer(
                        "🧭 **РЕЗУЛЬТАТЫ АУДИТА АВТОПИЛОТА**\n\n"
                        "⚠️ *Не удалось сгенерировать полный нейрокогнитивный отчет*\n\n"
                        "Однако на основе ваших ответов можно сделать следующие выводы:\n\n"
                        f"📊 *Индекс автоматизма:* {calculate_automatism_index(user_answers)}%\n\n"
                        "🔑 *Ваша Метаформула:*\n"
                        "ИСПОЛЬЗУЙТЕ СВОЙ СКРЫТЫЙ РЕСУРС\n\n"
                        "🚀 *Следующий шаг:*\n"
                        "Изучите гайд «Ревизия Маршрута» для получения полной инструкции по внедрению формулы.",
                        parse_mode="Markdown"
                    )
                    await send_offer_buttons(message)
                ...
                await message.answer(
                    "🧭 **РЕЗУЛЬТАТЫ АУДИТА**\n\n"
                    "📊 *Индекс автоматизма:* {calculate_automatism_index(user_answers)}%\n\n"
                    "🔑 *Ваша базовая формула:*\n"
                    "ПЕРЕЙТИ ИЗ РЕЖИМА РЕАГИРОВАНИЯ В РЕЖИМ СОЗДАНИЯ\n\n"
                    "🚀 *Следующий шаг:*\n"
                    "Изучите гайд «Ревизия Маршрута» для детальной инструкции.",
                    parse_mode="Markdown"
                )
                await send_offer_buttons(message)
