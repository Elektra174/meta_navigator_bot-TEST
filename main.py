...
ADMIN_ID = 7830322013  # Замените на ваш ID
...
MASTERCLASS_URL = "https://youtube.com/playlist?list=PLyour_playlist_id "  # Замените на вашу ссылку
...
# --- ОБНОВЛЕННЫЙ СПИСОК ВОПРОСОВ (8 ВОПРОСОВ) ---
QUESTIONS = [
    "В какой области жизни вы сейчас буксуете больше всего? Опишите конкретную ситуацию, где вы чувствуете, что стоите на месте.",
    "Представьте, что настройки вашей внутренней программы обновились и этот затык исчез. Что вы начнете делать иначе? Как изменятся ваши ощущения за день?",
...
def extract_shadow_role(answers: list) -> str:
    ...
    if len(answers) >= 6:
        ...
        inversion_map = {
            ...
            r'поверхностн[а-я]+': 'быть человеком, который углубляется в суть',
